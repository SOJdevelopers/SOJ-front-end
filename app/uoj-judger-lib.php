<?php
	...
	function rejudgeProblem($problem) {
		DB::update("update submissions set judge_time = NULL , result = '' , score = NULL , status = 'Waiting Rejudge' where problem_id = {$problem['id']}");
	}
	function rejudgeProblemAC($problem) {
		DB::update("update submissions set judge_time = NULL , result = '' , score = NULL , status = 'Waiting Rejudge' where problem_id = {$problem['id']} and score = 100");
	}
	function rejudgeProblemGe97($problem) {
		DB::update("update submissions set judge_time = NULL , result = '' , score = NULL , status = 'Waiting Rejudge' where problem_id = {$problem['id']} and score >= 97");
	}
	function rejudgeSubmission($submission) {
		DB::update("update submissions set judge_time = NULL , result = '' , score = NULL , status = 'Waiting Rejudge' where id = {$submission['id']}");
	}
