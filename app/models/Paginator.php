...
class Paginator {
	...
	public function __construct($config) {
		if (isset($config['data'])) {
			...
			$this->cur_start = ($this->cur_page - 1) * $this->page_len;
			if ($config['custom_query']) {
				$this->table = DB::selectAll($config['custom_query']);
			} else {
	...
	public function pagination() {
		...
		if ($this->cur_page > 1) {
			$html .= '<li><a href="'.$this->getPageUri(1).'"><span class="glyphicon glyphicon glyphicon-step-backward"></span></a></li>';
			$html .= '<li><a href="'.$this->getPageUri($this->cur_page - 1).'"><span class="glyphicon glyphicon glyphicon-triangle-left"></span></a></li>';
		} else {
			$html .= '<li class="disabled"><a><span class="glyphicon glyphicon glyphicon-step-backward"></span></a></li>';
			$html .= '<li class="disabled"><a><span class="glyphicon glyphicon glyphicon-triangle-left"></span></a></li>';
		}
		...
		if ($this->cur_page < $this->n_pages) {
			$html .= '<li><a href="'.$this->getPageUri($this->cur_page + 1).'"><span class="glyphicon glyphicon glyphicon-triangle-right"></span></a></li>';
			$html .= '<li><a href="'.$this->getPageUri($this->n_pages).'"><span class="glyphicon glyphicon glyphicon-step-forward"></span></a></li>';
		} else {
			$html .= '<li class="disabled"><a><span class="glyphicon glyphicon glyphicon-triangle-right"></span></a></li>';
